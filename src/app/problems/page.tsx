...
const hover_row = `hover:bg-lime-900`;
      ...
      <table className="table-auto">
        <thead className={table_row}>
          <tr>
            ...
            <th className={table_row}>Deck Id</th>
            <th className={table_row}>Deck Title</th>
        ...
        <tbody>
          {problems.map((prob) => (
            <tr key={prob.id} className={hover_row}>
              ...
              <td className={table_row}>{prob.deck.id}</td>
              <td className={table_row}>{prob.deck.title}</td>
